;some error happened in the system
...
;son 32 interruptores estos son los del sistema errores 

;estos son de las otras cosas
...
irq_basic:
    ...
    ;al master siempre se le dice
    ;al slave no siempre el interruptor tiene que pertenecer al slave
